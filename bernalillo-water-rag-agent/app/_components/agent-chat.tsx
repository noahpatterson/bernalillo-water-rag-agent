...
import { Client, type MessageStreamEvent, type ClientSessionState } from "eve/client";
...
const AGENT_NAME = "bernalillo-water-rag-agent";
...
export function AgentChat() {
  ...
  useEffect(() => {
    const raw = window.localStorage.getItem("eve-chat");
  ...
  return <AgentChatSession saved={saved} />;
}
      ...
      <div className="mx-auto flex w-full max-w-xl flex-1 flex-col items-center justify-center gap-8 px-4 pb-[10vh] sm:px-6">
        ...
        <div className="w-full">
          <PromptInput onSubmit={() => undefined}>
            <PromptInputTextarea placeholder="Send a message…" disabled />
...
function AgentChatSession({ saved }: { readonly saved: SavedEveChat }) {
